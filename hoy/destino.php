...
<html lang="es">
  ...
  <body>
    <?php
        ...
        $b = $_REQUEST['inputnombre'];
        $c = $_REQUEST['inputtronco'];
        $d = $_REQUEST['inputfruto'];
        $e = $_REQUEST['inputdescripcion'];
        $f = $_REQUEST['inputsitio'];
        $g = $_REQUEST['inputubicacion'];
        ...
        $nombre_c = "Con corteza";
        break;

        case '4': 

        $nombre_c = "Sin corteza";
        break;
    ...
    $SQL = "INSERT INTO arbol (id_hoja,nombre,id_tronco,fruto,descripcion,sitio,ubicacion)                          
    ...
    <form action="creararbol.php">
        <div class="form-row text-success text-left">   
            <div class="form-group col-md-4">
                <label class="text-secondary" for="inputDocumento"><font size="5">Tipo hoja</font></label>                                                  
                <input type="text" class="form-control" id="inputhoja" name="inputhoja" value="<?php echo $a;?>" readonly>
            </div>
            <div class="form-group col-md-8">
                <label class="text-secondary" for="inputNombre"><font size="5">Nombre Completo</font></label>                                                   
                <input type="text" class="form-control" id="inputNombre" name="inputnombre" value="<?php echo $b;?>" readonly >
            </div>          
        </div>
        <div class="form-row text-secondary text-left">
            <div class="form-group col-md-4">
                <label class="text-secondary" for="inputPerfil"><font size="5">Tipo tronco</font></label>                                                    
                <input type="text" class="form-control" id="inputtronco" name="inputtronco" value="<?php echo $nombre_c;?>" readonly>        
            </div>
            <div class="form-group col-md-4">
                <label class="text-secondary" for="inputfruto"><font size="5">Fruto</font></label>                                                  
                <input type="text" class="form-control" id="inputfruto" name="inputfruto" value="<?php echo $nombre_d;?>" readonly>
            </div>
            <div class="form-group col-md-4">
                <label class="text-secondary" for="inputTelefono"><font size="5">Descripción</font></label>                                                    
                <input type="text" class="form-control" id="inputTelefono" name="inputtelefono" value="<?php echo $e;?>" readonly></input>
            </div>      
        </div>
        <div class="form-row text-secondary text-left">
              <div class="form-group col-md-6">
                <label class="text-secondary" for="inputsitio"><font size="5">Sitio</font></label>                                                  
                <input type="text" class="form-control" id="inputsitio" name="inputsitio" value="<?php echo $nombre_f;?>" readonly>
              </div>
              <div class="form-group col-md-6">
                <label class="text-secondary" for="inputubicacion"><font size="5">Ubicación</font></label>                                                  
                <input type="text" class="form-control" id="inputubicacion" name="inputubicacion" value="<?php echo $g;?>" readonly>
              </div>
