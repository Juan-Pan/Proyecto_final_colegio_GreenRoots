...
<html lang="es">
  ...
  <body>
	...
	$SQL1 = "SELECT arbol.*, hoja.id_hoja, hoja.tipo_hoja, tronco.id_tronco, tronco.id_tronco, fruto.id_fruto, fruto.fruto FROM arbol 			
			INNER JOIN hoja
			INNER JOIN tronco
      INNER JOIN fruto
      ...
      AND arbol.fruto = fruto.id_fruto
			AND tronco.id_tronco = tronco.id_tronco";	
      ...
      <div class="form-row text-success text-left">	
        ...
        <label class="text-success" for="inputfruto">fruto</label>	
					...
					echo'<select required class="form-control"id="inputfruto" name="inputfruto">';	
						echo "<option value='$id_fruto' selected>$fruto</option>";						
				...
				<div class="form-group col-md-8">
					...
					<input type="text" class="form-control" id="inputubicacion" name="inputubicacion" value="<?php echo $ubicacion; ?>" >  
				</div>			
			</div>
			<div class="form-row text-success text-left">
				<div class="form-group col-md-4">
				...
				<div class="form-group col-md-4">
					...
					echo "<option value='$id_tronco' selected>$tipo_tronco</option>";
				...
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" id="inputTelefono" name="inputTelefono" value="<?php echo $origen; ?>" >  
				</div>		
			</div>	
