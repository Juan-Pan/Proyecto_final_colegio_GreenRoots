...
<html lang="es">
  <head>
    ...
    <style>
      .header{
        width: 100%;
        background-image: url(banners/flor1_ver.png);
    ...
    <div class="container-fluid">  
        <div class="row justify-content-md-center">
            <div class="card " style="--i:url(imagenes/arbol15.jpg)">
                <div class="content">
                    <h2>Algarrobo</h2>
            ...
            <div class="card " style="--i:url(imagenes/arbol16.jpg)">
                <div class="content">
                    <h2>Guanábano</h2>
            ...
            <div class="card " style="--i:url(imagenes/arbol19.1.jpg)">
                <div class="content">
                    <h2>Guayabo</h2>
    ...
    <div class="container">
      ...
      <section class="mt-5">
        ...
        <div class="row text-center d-flex justify-content-center pt-5">
          ...
          <div class="col-md-4">
            <h6 class="text-uppercase font-weight-bold">
              <a href="about.php" class="text-white">¿Quienes somos?</a>
            </h6>
          </div>
          <!-- columna -->
        </div>
