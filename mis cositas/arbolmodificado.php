...
<html lang="es">
  <head>
	...
	$id_hoja = $_REQUEST['inputPerfilLector'];
	$id_tronco = $_REQUEST['inputGrupoLector'];
	$origen = $_REQUEST['inputTelefono'];
    $ubicacion = $_REQUEST['inputubicacion'];
	...
	$SQL1 = "UPDATE arbol SET nombre = '$nombre_arbol', id_hoja = '$id_hoja', 
			id_tronco = '$id_tronco', origen = '$origen', fruto = '$fruto', ubicacion = '$ubicacion'
	...
	<div class="jumbotron">
		...
		<form action="indexadmin.php" method="POST" enctype="multipart/form-data">	
            ...
            <div class="form-row text-success text-left">	
				...
				<div class="form-group col-md-8">
					<label class="text-success" for="inputubicacion">Ubicacion</label>													
					<input type="text" class="form-control" id="inputubicacion" name="inputubicacion" value="<?php echo $ubicacion; ?>" readonly>  
				</div>			
			</div>
			<div class="form-row text-success text-left">
				<div class="form-group col-md-4">
