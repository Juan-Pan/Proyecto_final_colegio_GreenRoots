...
<html lang="es">
  ...
  <body >
	...
	<div class="jumbotron" style= "background-color: #272121">
		<h1 class="display-4" align="center"> <font color="#f2f2f2">Crear árbol</font></h1>
    <form action="destino.php">
		<div class="form-row text-success text-left">	
			<div class="form-group col-md-4">
      <label class="text-secondary" for="inputhoja"><font color="#f2f2f2" size="5">Tipo hoja </font></label>													
          ...
          <option value="5">Delgada</option>
			...
			<div class="form-group col-md-8">
				<label class="text-secondary" for="inputnombre"><font color="#f2f2f2" size="5">Nombre árbol</font></label>													
				<input type="text" class="form-control" id="inputnombre" name="inputnombre" placeholder="Ingresa campo" required>
			</div>			
		</div>
		<div class="form-row text-success text-left">
			<div class="form-group col-md-4">
				<label class="text-secondary" for="inputtronco"><font color="#f2f2f2" size="5">Tipo tronco </font></label>													
			...
			<div class="form-group col-md-4">
				<label class="text-secondary" for="inputfruto"><font color="#f2f2f2" size="5">Fruto</font></label>			
			...
			<div class="form-group col-md-4">
				<label class="text-secondary" for="inputdescripcion"><font color="#f2f2f2" size="5">Origen</font></label>													
				<select class="form-control" aria-label="Default select example" id="inputfruto" name="inputfruto" required>
				  <option selected disabled value>Escoge...</option>
				  <option value="1">No aplica</option>
				  <option value="2">Si</option>
    ...
    <div class="form-row text-success text-left">
      <div class="form-group col-md-6">
				<label class="text-secondary" for="inputsitio"><font color="#f2f2f2" size="5">Sitio</font></label>			
      ...
      <div class="form-group col-md-6">
				<label class="text-secondary" for="inputubicaion"><font color="#f2f2f2" size="5">Ubicación</font></label>													
  ...
  <div class="form-row text-success text-left">
		...
		<button type="submit" class="btn btn-block " style="background-color: #FF7F3F">
				...
				</svg> <font color="#f2f2f2" size="4px">Enviar!</font>
			</button>
			</div>
			<div class="form-group col-md-6">
			<button type="reset" class="btn btn-block " style="background-color: #FF7F3F">
				...
				</svg> <font color="#f2f2f2" size="4px">Eliminar!</font>
			</button>
			</div>	
		</div>
  </div>
