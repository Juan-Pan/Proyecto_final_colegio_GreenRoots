...
<html lang="es">
  <head>
    ...
    <style>
      .header{
        width: 100%;
        background-image: url(banners/entrada2_ver.png);
    ...
    <div class="container-fluid">  
        <div class="row justify-content-md-center">
            <div class="card " style="--i:url(imagenes/arbol49.jpg)">
                <div class="content">
                    <h2>Palma Reina</h2>
                    <a href="arbol50.php" class="btn" style="background-color: #FF7F3F" ><font color="f2f2f2">Ver Detalles</font></a>
                </div>
            </div>

            <div class="card " style="--i:url(imagenes/arbol50.jpg)">
                <div class="content">
                    <h2>Higuerón</h2>
                    <a href="arbol49.php" class="btn" style="background-color: #FF7F3F" ><font color="f2f2f2">Ver Detalles</font></a>
                </div>
            </div>
        </div>
    </div>    
