    ...
    <div class="container-fluid">  
        <div class="row justify-content-md-center">
            <div class="card " style="--i:url(imagenes/arbol12.jpg)">
                <div class="content">
                    <h2>Hayuelo</h2>
                    <a href="arbol12.php" class="btn" style="background-color: #FF7F3F" ><font color="f2f2f2">Ver Detalles</font></a>
                </div>
            </div>
            ...
            <div class="card " style="--i:url(imagenes/arbol13.jpg)">
                <div class="content">
                    <h2>Palma Real</h2>
                    <a href="arbol13.php" class="btn" style="background-color: #FF7F3F" ><font color="f2f2f2">Ver Detalles</font></a>
                </div>
            </div>
            ...
            <div class="card " style="--i:url(imagenes/arbol14.jpg)">
                <div class="content">
                    <h2>Mango</h2>
                    <a href="arbol14.php" class="btn" style="background-color: #FF7F3F" ><font color="f2f2f2">Ver Detalles</font></a>
                </div>
            </div>
