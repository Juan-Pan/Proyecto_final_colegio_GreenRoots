...
<html lang="es">
  ...
  <body style="background-color:#272121">
    ...
    <div class="mb-12" style="background-color: #A2CC3E">
        <div class="row no-gutters">
            <div class="col-md-5">
                <img src="imagenes/arbol6.jpg" alt="..." width="100%" >
            </div>
            <br>
            ...
            <div class="col-md-7">
                ...
                <p class="card-text" align="justify"><font color="#f2f2f2" size="4px">Es llamada, comúnmente, limoncillo ornamental, limón swingla o swinglea.
                <br>
                Es un arbusto vistoso originario de Asia, que inicialmente fue introducido a Colombia por los
                productores de caña para establecer cercas vivas. El limón swingle tupe muy cerrado y es
                bastante espinoso lo que lo hace decorativo y a la vez seguro. Es quizás una de las cercas
                vivas más populares entre los finqueros en Colombia, donde se distribuye entre 0 y 1200 m.
                <br>
                Esta especie es de crecimiento rápido, para lo cual requiere abundante luz solar y riego
                diario durante los primeros meses después de la siembra.
                <br>
                <b>Fruto</b> su fruto de entre 10-12 cm NO es comestible.
                <br>
                En realidad la planta no es muy exigente, puede crecer mejor en suelos bien drenados y
                fértiles, con un pH entre 5 y 7.
                <br>
                La especie florece y fructifica dos veces al año, el árbol puede llegar a crecer hasta 15 m2 y
                presentar un DAP (diámetro a la altura del pecho) de 40 cm. 
                </font></p>

                <p class="card-text" ><font color="#f2f2f2" size="5px"><b>Usos:</b></font></p>

                <p class="card-text" align="justify"><font color="#f2f2f2" size="4px">La swinglea se utiliza principalmente para cercas vivas, ya que por su follaje denso y alta
                cantidad de espinas, en algunos casos prácticamente elimina la necesidad de postes y
                alambre. Se utiliza también como rompeviento y protección de predios.
                <br>
