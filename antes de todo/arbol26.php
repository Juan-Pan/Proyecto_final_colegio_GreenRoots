...
<html lang="es">
  ...
  <body style="background-color:#272121">
    ...
    <div class="mb-12" style="background-color: #A2CC3E">
        <div class="row no-gutters">
            <div class="col-md-5">
                <img src="imagenes/arbol26.jpg" alt="..." width="100%" >
            </div>
            <br>
            ...
            <div class="col-md-7">
                ...
                <p class="card-text" align="justify"><font color="#f2f2f2" size="4px">Es un género de unas 140 especies aceptadas, de las casi 400 descritas, de árboles y
                arbustos, subtropicales y tropicales.
                <br>
                Árboles o arbustos generalmente inermes, raramente trepadoras con zarcillos cortos y curvados.
                
                Género pantropical, de Asia, África, Madagascar, América Central, América del Sur, sur de
                Norteamérica, Australia, pero mayormente en los trópicos del Viejo Mundo.
                <br>
                Albizia julibrissin, se extiende bien al norte en regiones templadas del este de Asia, y es
                de lejos el árbol más resistente a heladas, tolerando temperaturas debajo de cerca de
                -30 °C, y necesitando veranos adecuados de temperatura para madurar sus brotes. En
                Norteamérica, donde crece comúnmente como un árbol ornamental, es confundido
                llamándolo "mimosa", nombre correctamente usado para la especie en el género
                emparentado Mimosa.
                <br>
                En varios Estados de Estados Unidos, A. julibrissin se ha naturalizado y se comporta
                como una especie invasora.
                <br>
                <b>Hojas:</b> Las hojas son bi-pinadas. Las flores son hermafroditas, con un corto cáliz
                campanulado-cilíndrico penta-dentado. Las semillas son ovoides u orbiculares.
                <br>
                </font></p>
                ...
                La madera se emplea en la fabricación de guacales.
                </font></p>  
            </div>
