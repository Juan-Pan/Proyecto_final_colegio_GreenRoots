...
<body style="background-color: #272121">
  <header class="header">
    ...
    // Lectura del variables del formulario anterior
    $documento_usuario = $_REQUEST['inputarbol'];
    $nombre_arbol = $_REQUEST['inputNombre'];
    $id_hoja = $_REQUEST['inputhoja'];
    $id_tronco = $_REQUEST['inputtronco'];
    $origen = $_REQUEST['inputorigen'];
    $link = $_REQUEST['inputlink'];
    $fruto = $_REQUEST['inputfruto'];
    $sitio = $_REQUEST['inputsitio'];
    ...
    $SQL1 = "UPDATE arbol SET nombre = '$nombre_arbol', id_hoja = '$id_hoja', 
			id_tronco = '$id_tronco', origen = '$origen', fruto = '$fruto', link = '$link'
			WHERE id = '$documento_usuario'";
    ...
    ?>
      <div class="alert alert-success text-center" role="alert">
        ...
        </svg> árbol Modificado Satisfactoriamente!
      </div>
    <?php
    } else {
    ?>
      <div class="alert alert-danger text-center" role="alert">
        ...
        </svg> No se puede Modificar el árbol!
      </div>
    <?php
    }
    ...
    $SQL2 = "SELECT * FROM tronco WHERE id_tronco = '$id_tronco'";
    $registro2 = mysqli_query($idCone, $SQL2);
    $fila2 = mysqli_fetch_row($registro2);
    $tipo_tronco = $fila2[1];

    // Obtener el nombre del perfil
    $SQL3 = "SELECT * FROM hoja WHERE id_hoja = '$id_hoja'";
    $registro3 = mysqli_query($idCone, $SQL3);
    $fila3 = mysqli_fetch_row($registro3);
    $tipo_hoja = $fila3[1];

    $SQL4 = "SELECT * FROM fruto WHERE id_fruto = '$fruto'";
    $registro4 = mysqli_query($idCone, $SQL4);
    $fila4 = mysqli_fetch_row($registro4);
    $fruto = $fila4[1];

    $SQL5 = "SELECT * FROM sitio WHERE id_sitio = '$sitio'";
    $registro5 = mysqli_query($idCone, $SQL5);
    $fila5 = mysqli_fetch_row($registro5);
    $sitio = $fila5[1];
        ...
        <form action="indexadmin.php" method="POST" enctype="multipart/form-data">
          <div class="form-row text-success text-left">
            <div class="form-group col-md-4">
              <label class="text-success" for="inputDocumento">ID</label>
              <input type="text" class="form-control" id="inputDocumento" name="inputDocumento" value="<?php echo $documento_usuario; ?>" readonly>
            </div>
            <div class="form-group col-md-8">
              <label class="text-success" for="inputNombre">Nombre árbol</label>
              <input type="text" class="form-control" id="inputNombre" name="inputNombre" value="<?php echo $nombre_arbol; ?>" readonly>
            </div>
          ...
          <div class="form-row text-success text-left">
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" id="inputfruto" name="inputfruto" value="<?php echo $fruto; ?>" readonly>
            </div>
            <div class="form-group col-md-4">
              <label class="text-success" for="inputubicacion">Link</label>
              <input type="text" class="form-control" id="inputubicacion" name="inputubicacion" value="<?php echo $link; ?>" readonly>
            </div>
            <div class="form-group col-md-4">
              <label class="text-success" for="inputTelefono">Sitio</label>
              <input type="text" class="form-control" id="inputTelefono" name="inputTelefono" value="<?php echo $sitio; ?>" readonly>
            </div>
          </div>
          <div class="form-row text-success text-left">
            <div class="form-group col-md-4">
              <label class="text-success" for="inputPerfilLector">Hoja</label>
              <input type="text" class="form-control" id="inputPerfilLector" name="inputPerfilLector" value="<?php echo $tipo_hoja; ?>" readonly>
            </div>
            <div class="form-group col-md-4">
              <label class="text-success" for="inputGrupoLector">Tronco</label>
              <input type="text" class="form-control" id="inputGrupoLector" name="inputGrupoLector" value="<?php echo $tipo_tronco; ?>" readonly>
            </div>
            <div class="form-group col-md-4">
              <label class="text-success" for="inputTelefono">Origen</label>
              <input type="text" class="form-control" id="inputTelefono" name="inputTelefono" value="<?php echo $origen; ?>" readonly>
            </div>
          </div>
