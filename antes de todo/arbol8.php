...
<html lang="es">
  ...
  <body style="background-color:#272121">
    ...
    <div class="mb-12" style="background-color: #A2CC3E">
        <div class="row no-gutters">
            <div class="col-md-5">
                <img src="imagenes/arbol8.jpg" alt="..." width="100%" >
            </div>
            <br>
            ...
            <div class="col-md-7">
                ...
                <p class="card-text" align="justify"><font color="#f2f2f2" size="4px">Árbol mediano, de hasta 18 m de altura, originario de la región Caribe colombiana; su copa
                aparasolada, tronco recto de corteza grisácea a parda moteada.
                <br>
                <b>Hojas:</b> Hojas bipinnadas, flores pequeñas dispuestas en racimos de color amarillo con pintas
                rojizas.
                <br>
                <b>Fruto:</b> Fruto tipo legumbre casi orbicular de 6 - 8 cm de largo.
                <br>
                Los sitios de plantación no deben tener restricción en altura, con suelos preferiblemente
                bien drenados.
                <br>
                ...
                <p class="card-text" align="justify"><font color="#f2f2f2" size="4px">Su madera es muy usada en ebanistería, siendo exportada a Europa con el nombre de
                ébano por su parecido con el ébano Africano.
                <br>
                Es apropiado para separadores de avenidas, parques, corredores viales, cerros y zonas
                verdes en general.
                <br>
                Su madera casi negra es dura y pesada, muy apreciada en la elaboración de artesanías.
                </font></p>  
            </div>
