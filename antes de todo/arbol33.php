...
<html lang="es">
  ...
  <body style="background-color:#272121">
    ...
    <div class="mb-12" style="background-color: #A2CC3E">
        <div class="row no-gutters">
            <div class="col-md-5">
                <img src="imagenes/arbol33.2.jpg" alt="..." width="100%" >
            </div>
            <br>
            ...
            <div class="col-md-7">
                ...
                Conocida popularmente como "kurupika’y", "pau-de-leite", "pau-leiteiro", "lechero", "lechero
                de hoja graúda", "mataojo" o "toropi". Es endémica de Brasil, Perú y Paraguay.
                <br>
                Es un árbol lactescente, caducifolio que puede alcanzar hasta 20 m de altura, con tronco
                recto y cilíndrico con hasta 5 dm de diámetro. Hojas largas, espinosas, lanceoladas,
                simples, alternadas; florece en el Hemisferio Austral de octubre a enero, y fructifica de enero
                a marzo.
                <br>
                Como es una especie heliófila (requiere del sol directo para su crecimiento), o de luz difusa
                se encuentran en bosques no muy densos. En Brasil se registra su presencia en el sur y en
                el sudeste.
                <br>
                La madera es indicada para hacer cajas, y como leña para carbón. De su látex
                característico (de allí su nombre) se usa para producir hule.
                <br>
                ...
                <br>
                La nación guaraní usa su madera para esculpir animales.
                </font></p>
                <p class="card-text" ><font color="#f2f2f2" size="5px"><b>Usos:</b></font></p>
                <p class="card-text" align="justify"><font color="#f2f2f2" size="4px">La especie ayuda a la conservación de suelos y estabilización de cauces fluviales.
                La madera se puede utilizar para embalaje, paneles, marcos para puertas y ventanas, como
                pulpa para papel y como combustible (leña y carbón).
<br>
                Sus frutos apoyan la dieta de las aves y su savia se ha usado contra la esclerosis y las
                verrugas</font></p>  
            </div>
