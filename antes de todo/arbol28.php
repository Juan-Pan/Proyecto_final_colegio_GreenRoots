    ...
    <div class="mb-12" style="background-color: #A2CC3E">
        <div class="row no-gutters">
            ...
            <div class="col-md-7">
                ...
                <p class="card-text" align="justify"><font color="#f2f2f2" size="4px">Es una especie arbórea nativa del centro y sur del continente americano. Se distribuye
                desde Mesoamérica (Costa Rica, Honduras, Nicaragua, Panamá) hasta Sudamérica
                (Venezuela, Bolivia, Colombia, Ecuador, Perú). En Colombia recibe el nombre común de
                aguacatillo.
                <br>
                Árbol caducifolio (significa que sus hojas se caen estacionalmente) de crecimiento bastante
                rápido y raíces profundas.
                <br>
                Alcanza unos 20 m de altura con copa redondeada. Hojas simples y alternas. Las flores, de
                color blanco.
                <br>
                <b>Fruto:</b> El fruto es una baya globosa verde a negruzca, de menos de 1 cm de diámetro, consumida
                ...
                <p class="card-text" align="justify"><font color="#f2f2f2" size="4px">Apropiado para programas de revegetalización, corredores viales, retiros de quebradas, y
                en zonas verdes amplias complementando la vegetación existente. Por su cambio de hojas
                debe plantarse lejos de desagües y alcantarillas.
                <br>
                La madera se emplea en la fabricación de embarcaciones, construcciones pesadas y
                muebles.</font></p>  
            </div>
