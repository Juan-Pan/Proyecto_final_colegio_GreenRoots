...
<body style="background-color: #272121">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark p-3 mb-5 bg-white rounded">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            ...
            <li class="nav-item ">
              <a class="nav-link text-white" href="buscatuarbol.php">
  ...
  <div class="mb-12" style="background-color: #A2CC3E">
    <div class="row no-gutters">
      <div class="col-md-5">
        <img src="flor.png" width="100%" height="100%">
      </div>
      <div class="col-md-7">
        <div class="card-body">
          <br>
          <h1 class="card-title" align="center">
            <font color="#f2f2f2">Objetivos</font>
          </h1>
          <br>
          <p class="card-text" align="justify">
            <font color="#f2f2f2" size="4px">
              ...
              aportaciones que benefician a la comunidad educativa.
            </font>
          </p>
          <br>
          <br>
  ...
  <div class="container" aling="center">
    <div class="row justify-content-md-center">
      ...
      <div class="col-md-10">
        <video src="Compreso.mp4" width="100%" controls></video>
      </div>
      <div class="col-md-1">
  ...
  <div class="container-fluid" aling="center">
    <div class="row justify-content-md-center">
      <div class="card " style="--i:url(imagenes/arbol22.jpg)">
        <div class="content">
          <h2>Árboles</h2>
          <a href="arboles1.php" class="btn" style="background-color: #FF7F3F">
