...
<html lang="es">
  ...
  <body style="background-color:#272121">
    ...
    <div class="mb-12" style="background-color: #A2CC3E">
        <div class="row no-gutters">
            <div class="col-md-5">
                <img src="imagenes/arbol3.jpg" alt="..." width="100%" >
            </div>
            <br>
            ...
            <div class="col-md-7">
                ...
                <p class="card-text" align="justify"><font color="#f2f2f2" size="4px">La leucaena puede superar los 5 metros de altura, con más de 24 especies variables de
                ...
                <p class="card-text" align="justify"><font color="#f2f2f2" size="4px">Generalmente se utiliza en la forestación de lugares públicos de bajo mantenimiento o como
                ...
                <br>
                <b>Semillas:</b> Sus semillas verdes son comestibles, aunque algo insípidas.
                <br>
                <b>Hojas:</b> Las hojas y semillas contienen un aminoácido (mimosina) cuya ingesta en grandes
