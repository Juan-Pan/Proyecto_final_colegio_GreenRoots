...
<html lang="es">
  ...
  <body style="background-color:#272121">
    ...
    <div class="mb-12" style="background-color: #A2CC3E">
        <div class="row no-gutters">
            <div class="col-md-5">
                <img src="flor.png" alt="..." width="100%" >
            </div>
            ...
            <div class="col-md-7">
                ...
                Es un lugar ideal para escribir un texto largo sobre tu empresa y servicios. 
                Puedes usar este espacio para entrar en más detalle sobre tu empresa. Habla de tu equipo 
                y de los servicios que prestas. Cuenta a tus visitantes la historia de cómo se te ocurrió 
                la idea de tu negocio y qué lo hace diferente de la competencia. Haz que tu empresa se 
                destaque y muestra a tus visitantes quién eres.</font></p>
                </div>
