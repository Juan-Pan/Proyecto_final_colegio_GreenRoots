...
<html lang="es">
  ...
  <body style= "background-color: #102601">
    <header class="header">
      <!-- navbar -->
...
<div class="container-fluid">  
    <div class="row justify-content-md-center">
      <div class="card " style="--i:url(card_prueba.jpg)">
            <div class="content">
                <h2>Patios</h2>
                <a href="interior.php" class="btn btn-success">Ver Detalles</a>
            </div>
        </div>
  ...
  <!-- Footer -->
  <footer class="text-center text-white" style="background-color:  #214001">
    <!-- Container -->
    <div class="container">
      <!-- Navegación -->
      <section class="mt-5">
