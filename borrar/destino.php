...
<html lang="es">
  ...
  <body>
    ...
    $SQL = "INSERT INTO arbol (hoja,nombre,tronco,fruto,descripción)                          
            VALUES ('$a', '$b', '$c', '$d', '$e')"; 
    ...
    <div class="alert alert-success text-center" role="alert">
            ...
            </svg> Lector Guardado Satisfactoriamente!
        </div>  
    <?php                   
    }
    else
    ...
    ?> 
        <div class="alert alert-danger text-center" role="alert">
            ...
            </svg> No se puede Guardar el Lector, tal vez el código ya existe!
        </div>  
    <?php
    }
