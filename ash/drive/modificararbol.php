...
<html lang="es">
  ...
  <body>
	...
	$SQL = "SELECT id_hoja, nombre FROM arbol ORDER BY id_hoja ASC";			
		...
		<form action="arbolModificarSiguiente.php" method="POST" enctype="multipart/form-data">	
				<div class="form-row text-success text-left">
					<div class="form-group col-md-12">									
						...
						<h3 class="d-flex justify-content-center text-secondary" for="inputDocumento">
						<?php // Inicio código en PHP							
						echo'<select required class="form-control" id="inputDocumento" name="inputDocumento" autofocus="autofocus">';												 
			...
			Siguiente <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-chevron-double-right" viewBox="0 0 16 16">
