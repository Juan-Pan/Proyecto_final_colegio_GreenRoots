...
<html lang="es">
  <head>
    ...
    <style>
      .header{
        width: 100%;
        background-image: url(imagenes/polvera1.jpg);
    ...
    <div class="container-fluid">  
        <div class="row justify-content-md-center">
            <div class="card " style="--i:url(imagenes/arbol16.1.jpg)">
                <div class="content">
                    <h2>Algarrobo</h2>
                    <a href="arbol15.php" class="btn" style="background-color: #FF7F3F" ><font color="f2f2f2">Ver Detalles</font></a>
                </div>
            </div>

            <div class="card " style="--i:url(imagenes/arbol17.jpg)">
                <div class="content">
                    <h2>Guanábano</h2>
                    <a href="arbol16.php" class="btn" style="background-color: #FF7F3F" ><font color="f2f2f2">Ver Detalles</font></a>
                </div>
            </div>

            <div class="card " style="--i:url(imagenes/arbol18.jpg)">
                <div class="content">
                    <h2>Palo Blanco</h2>
                    <a href="arbol17.php" class="btn" style="background-color: #FF7F3F" ><font color="f2f2f2">Ver Detalles</font></a>
                </div>
            </div>
            <div class="card " style="--i:url(imagenes/arbol19.jpg)">
                <div class="content">
                    <h2>Guanábano</h2>
                    <a href="arbol18.php" class="btn" style="background-color: #FF7F3F" ><font color="f2f2f2">Ver Detalles</font></a>
                </div>
            </div>

            <div class="card " style="--i:url(imagenes/arbol20.jpg)">
                <div class="content">
                    <h2>Guayabo</h2>
                    <a href="arbol19.php" class="btn" style="background-color: #FF7F3F" ><font color="f2f2f2">Ver Detalles</font></a>
                </div>
            </div>
        </div>
