  ...
  <body>
    <?php
        ...
        switch ($b) {
          ...
          $nombre_b = "Con corteza";
          break;
  
          case '4': 
  
          $nombre_b = "Sin corteza";
          break;
    ...
    $SQL = "INSERT INTO arbol (id_hoja,id_tronco,fruto,nombre,descripcion,ubicacion,sitio)                          
    ...
    <form action="creararbol.php">
        ...
        <div class="form-row text-secondary text-left">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="inputubicacion" name="inputubicacion" value="<?php echo $f;?>" readonly>
              </div>
