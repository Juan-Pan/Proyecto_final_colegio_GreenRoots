...
<html lang="es">
  <head>
    ...
    <style>
      .header{
        background-image: url(imagenes/patio1.jpg); 
  ...
  <body style="background-color:#272121">
    ...
    <div class="mb-12" style="background-color: #A2CC3E">
        <div class="row no-gutters">
            <div class="col-md-5">
                <img src="imagenes/arbol14.5.jpg" alt="..." width="100%" >
            </div>
            <br>
            ...
            <div class="col-md-7">
                ...
                diámetro.
                <br>
                Hojas alternas, simples, coriáceas, de lanceoladas a oblongas, de 15-30 cm de longitud, de
                color verde oscuro, inflorescencias en panículas axilares o terminales.
                <br>
                Sus flores poseen cinco pequeños sépalos verdes y peludos con cinco pétalos separados
                ...
                <br>
                El fruto es una drupa (carnoso) que destaca entre sus principales características su buen
