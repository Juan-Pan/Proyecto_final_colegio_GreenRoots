    ...
    <div class="mb-12" style="background-color: #A2CC3E">
        <div class="row no-gutters">
            ...
            <div class="col-md-7">
                ...
                <p class="card-text" align="justify"><font color="#f2f2f2" size="4px">Árbol mediano, en las zonas frías puede sobrepasar los 20 m; originario de América, desde
                México hasta Bolivia.
                <br>
                Con tronco recto de 30 cm de diámetro y ramas extendidas; copa ovalada con follaje denso
                verde brillante.
                <br>
                Las hojas son simples, opuestas, dispuestas en un solo plano; de color verde brillante, se
                tornan rojas al marchitarse.
                <br>
                Las flores son grandes y blancoamarillentas, con 6 pétalos blancos como rizados en el
                borde y 24 estambres muy largos de color crema.
                <br>
                Los frutos son cápsulas globosas de 3 cm de diámetro, dehiscentes y con numerosas
                semillas aladas.
                <br>
                ...
                <p class="card-text" align="justify"><font color="#f2f2f2" size="4px">La madera dura, pesada y durable, se utiliza en la construcción, carpintería y para hacer
                objetos torneados.
                <br>
