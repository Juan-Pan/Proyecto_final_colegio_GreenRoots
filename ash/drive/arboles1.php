...
<div class="container-fluid">  
    <div class="row justify-content-md-center">
      <div class="card " style="--i:url(imagenes/gota1.2.jpg)">
            <div class="content">
                <h2>Entrada</h2>
                <a href="entrada.php" class="btn" style="background-color: #FF7F3F" ><font color="f2f2f2">Ver Detalles</font></a>
            </div>
        </div>
        ...
        <div class="card " style="--i:url(imagenes/patio.jpg)">
            <div class="content">
                <h2>Patios</h2>
                <a href="interior.php" class="btn" style="background-color: #FF7F3F" ><font color="f2f2f2">Ver Detalles</font></a>
            </div>
        </div>
        ...
        <div class="card " style="--i:url(imagenes/arbusto.jpg)">
            <div class="content">
                <h2>Biblioteca</h2>
                <a href="biblioteca" class="btn" style="background-color: #FF7F3F" ><font color="f2f2f2">Ver Detalles</font></a>
            </div>
        </div>

        <div class="card " style="--i:url(imagenes/sendero3.jpg)">
            <div class="content">
                <h2>Sendero</h2>
                <a href="sendero.php" class="btn" style="background-color: #FF7F3F" ><font color="f2f2f2">Ver Detalles</font></a>
            </div>
        </div>

        <div class="card " style="--i:url(imagenes/polvera.jpg)">
            <div class="content">
                <h2>Música</h2>
                <a href="musica.php" class="btn" style="background-color: #FF7F3F" ><font color="f2f2f2">Ver Detalles</font></a>
            </div>
        </div>
    </div>
    <!-- Fin cartas  -->
