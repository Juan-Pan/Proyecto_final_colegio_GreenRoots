    ...
    <div class="mb-12" style="background-color: #A2CC3E">
        <div class="row no-gutters">
            ...
            <div class="col-md-7">
                ...
                <p class="card-text" align="justify"><font color="#f2f2f2" size="4px">Bigotillo (Caesalpinia pulcherrima) o Ponciana enana es endémica de los trópicos de
                América.
                <br>
                sus flores crecen a manera de racimos con pétalos de color amarillo. En México tiene mayor
                ...
                <br>
                Las hojas son bipinnadas, cada flor con 5 pétalos amarillos, anaranjados o rojos. Fruto
                legumbre de 6 a 12 cm de largo.
                <br>
                Es una llamativa planta ornamental, muy cultivada en jardines tropicales. Es la "Flor
                Nacional" de la isla caribeña de Barbados.</font></p>
                
                <p class="card-text" ><font color="#f2f2f2" size="5px"><b>Usos medicinales:</b></font></p>
                <p class="card-text" align="justify"><font color="#f2f2f2" size="4px">Los chamanes del Amazonas lo han usado tradicionalmente; conocido como ayoowiri.
                <br>
                ...
                <br>
                4 g de la raíz induce al aborto en el primer trimestre de embarazo.</font></p>
            </div>
